...
//	   System.out.println("should be 0  but is : " + completions.size());
		completions = smallDict.predictCompletions("",  4);
//		System.out.println("should be 4 but it is : " + completions.size());
//		smallDict.printTree();
...
//		System.out.println("should be 2 but it is : " + completions.size());
//		smallDict.printTree();
//		System.out.println(smallDict.isWord("he"));
//		for(String x : completions) {
...
//		System.out.println(allIn);
		...
		assertTrue(allIn);
//		System.out.println("this is "+ allIn);
