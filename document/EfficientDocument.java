...
public class EfficientDocument extends Document {
	...
	private void processText() 
	{
		...
		for(String str : tokens) {
			if(isWord(str)) {
				this.numWords++;
				number_of_syllables = countSyllables(str);
				this.numSyllables +=number_of_syllables;
			}
			else {
				this.numSentences++;
...
//		System.out.println("i have done process test");
//		Thread.sleep(1000);
...
//		System.out.println("sentences donot do that");
	...
	public int getNumWords() {
		//TODO: write this method.  Hint: It's simple
//		System.out.println("words donot do that");
	...
	public int getNumSyllables() {
        ...
        //TODO: write this method.  Hint: It's simple
//		System.out.println("hey bro syllables donot do that");
